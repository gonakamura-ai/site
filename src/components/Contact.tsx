        ...
        <div className="relative bg-white shadow-xl rounded-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative overflow-hidden rounded-tl-2xl rounded-bl-2xl py-10 px-6 bg-gradient-to-br from-indigo-600 to-indigo-800 sm:px-10 xl:p-12">
              ...
              <h2 className="text-3xl font-bold text-white">お問い合わせ</h2>
              <p className="mt-6 text-base text-indigo-50 max-w-3xl">
                サービスについてのご質問や、お見積もりのご依頼など、お気軽にお問い合わせください。
                専門スタッフが丁寧にご対応いたします。
              </p>
              <dl className="mt-8 space-y-6">
                <dt><span className="sr-only">所在地</span></dt>
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">〒100-0001 東京都千代田区1-1-1<br />サンプルビル10F</span>
                </dd>
                <dt><span className="sr-only">電話番号</span></dt>
                <dd className="flex text-base text-indigo-50">
                  <svg className="flex-shrink-0 w-6 h-6 text-indigo-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="ml-3">03-1234-5678（平日 9:00-18:00）</span>
                </dd>
                <dt><span className="sr-only">メールアドレス</span></dt>
                <dd className="flex text-base text-indigo-50">
                  <svg className="flex-shrink-0 w-6 h-6 text-indigo-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-1 xl:p-12">
              <h3 className="text-lg font-medium text-gray-900">お問い合わせフォーム</h3>
              {!submitted ? (
